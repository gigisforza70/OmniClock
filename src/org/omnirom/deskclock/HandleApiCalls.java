...
public class HandleApiCalls extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        try {
            ...
            if (intent != null) {
                ...
                } else if ("org.omnirom.deskclock.ACTION_SHOW_STOPWATCH".equals(intent.getAction())) {
                    handleShowStopwatch();
                }
            }
        } finally {
    ...
    private void handleShowStopwatch() {
        ...
        LogUtils.i("HandleApiCalls show stopwatch");
    }
    ...
    private void setSelectionFromIntent(
        ...
        if (intent.hasExtra(EXTRA_RINGTONE)) {
            ...
            if (ringTone == null) {
                ...
                // ringtone.
                Uri ringToneUri = Utils.getDefaultAlarmUri(this);
                if (ringToneUri == null) {
                    ringToneUri = mAlarms.get(0);
                }
