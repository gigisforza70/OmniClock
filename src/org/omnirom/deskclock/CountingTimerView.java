...
/**
 * Class to measure and draw the time in the {@link CircleTimerView}.
...
public class CountingTimerView extends View {
     ...
     * {@link CircleTimerView#onDraw(android.graphics.Canvas)}
     */
    ...
    private static String getTimeStringForAccessibility(int hours, int minutes, int seconds,
        ...
        if (showNeg && hours == 0 && minutes == 0) {
            ...
            s.append(String.format(
                    r.getQuantityText(org.omnirom.deskclock.R.plurals.Nseconds_description, seconds).toString(),
                    seconds));
        } else if (hours == 0) {
            s.append(String.format(
                    r.getQuantityText(org.omnirom.deskclock.R.plurals.Nminutes_description, minutes).toString(),
                    minutes));
            s.append(" ");
            s.append(String.format(
                    r.getQuantityText(org.omnirom.deskclock.R.plurals.Nseconds_description, seconds).toString(),
            ...
            s.append(String.format(
                    r.getQuantityText(org.omnirom.deskclock.R.plurals.Nhours_description, hours).toString(),
                    hours));
            s.append(" ");
            s.append(String.format(
                    r.getQuantityText(org.omnirom.deskclock.R.plurals.Nminutes_description, minutes).toString(),
