...
public class LabeledSwitch extends View {
    ...
    private void initView() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            colorBorder = colorOn = getResources().getColor(R.color.primary, getContext().getTheme());
        } else {
            colorBorder = colorOn = getResources().getColor(R.color.primary);
        }
    ...
    private void initProperties(AttributeSet attrs) {
        ...
        for (int i = 0; i < N; ++i) {
            ...
            if (attr == R.styleable.Toggle_on) {
                ...
                int accentColor;
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                    accentColor = getResources().getColor(R.color.primary, getContext().getTheme());
                } else {
...
//      Drawing Switch Thumb here
    ...
    public interface OnToggledListener {
         ...
         */
        void onSwitched(LabeledSwitch toggleableView, boolean isOn);
    }
}