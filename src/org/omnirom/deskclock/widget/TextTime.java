...
public class TextTime extends AppCompatTextView {
    ...
    public TextTime(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray styledAttributes = context.obtainStyledAttributes(
                attrs, org.omnirom.deskclock.R.styleable.TextTime, defStyle, 0);
        try {
            mFormat12 = styledAttributes.getText(org.omnirom.deskclock.R.styleable.TextTime_format12Hour);
            mFormat24 = styledAttributes.getText(org.omnirom.deskclock.R.styleable.TextTime_format24Hour);
        } finally {
    ...
    public void setFormat(int amPmFontSize, int secondsSize) {
        setFormat12Hour(Utils.get12ModeFormat(amPmFontSize, secondsSize));
        setFormat24Hour(Utils.get24ModeFormat(secondsSize));
    }
