...
public class TimerFullScreenFragment extends DeskClockFragment
    ...
    private class TimersListAdapter extends GridAdapter {
            ...
            for (int i = 0; i < mTimers.size(); i++) {
                ...
                if (t.mTimerId == id) {
                    ...
                    if (mTimers.size() == 1 && mColumnCount > 1) {
                        ...
                        mTimersList.setAnimationMode(SgvAnimationHelper.AnimationIn.FADE, SgvAnimationHelper.AnimationOut.FADE);
                    } else {
                        mTimersList.setAnimationMode(
                                SgvAnimationHelper.AnimationIn.FLY_IN_NEW_VIEWS, SgvAnimationHelper.AnimationOut.FADE);
                    }
                    notifyDataSetChanged();
                    return;
                }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final TimerListItem v = (TimerListItem) inflater.inflate(org.omnirom.deskclock.R.layout.timer_list_item,
                    null);
            ...
            final CountingTimerView countingTimerView = (CountingTimerView)
                    v.findViewById(org.omnirom.deskclock.R.id.timer_time_text);
            ...
            CircleButtonsLayout circleLayout =
                    (CircleButtonsLayout) v.findViewById(org.omnirom.deskclock.R.id.timer_circle);
            circleLayout.setCircleTimerViewIds(org.omnirom.deskclock.R.id.timer_time, org.omnirom.deskclock.R.id.reset_add, org.omnirom.deskclock.R.id.timer_label,
                    org.omnirom.deskclock.R.id.timer_label_text);

            ImageButton resetAddButton = (ImageButton) v.findViewById(org.omnirom.deskclock.R.id.reset_add);
            resetAddButton.setTag(new ClickAction(ClickAction.ACTION_PLUS_ONE, o));
            v.setResetAddButton(true, TimerFullScreenFragment.this);
            FrameLayout label = (FrameLayout) v.findViewById(org.omnirom.deskclock.R.id.timer_label);
            TextView labelIcon = (TextView) v.findViewById(org.omnirom.deskclock.R.id.timer_label_placeholder);
            TextView labelText = (TextView) v.findViewById(org.omnirom.deskclock.R.id.timer_label_text);
            if (o.mLabel.equals("")) {
    ...
    public void onResume() {
        ...
        if (getActivity() instanceof DeskClock) {
            ...
            View footerView = getActivity().getLayoutInflater().inflate(
                    org.omnirom.deskclock.R.layout.blank_footer_view, mTimersList, false);
    ...
    private void gotoSetupView() {
        if (mLastVisibleView == null || mLastVisibleView.getId() == org.omnirom.deskclock.R.id.timer_setup) {
    ...
    private void gotoTimersView() {
        if (mLastVisibleView == null || mLastVisibleView.getId() == org.omnirom.deskclock.R.id.timers_list_page) {
