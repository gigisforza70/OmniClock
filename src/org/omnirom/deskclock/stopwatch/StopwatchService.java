...
public class StopwatchService extends Service {
    ...
    private void setNotification(long clockBaseTime, boolean clockRunning, int numLaps) {
        if (Utils.isNougatOrLater()) {
            setNotificationNew(clockBaseTime, clockRunning, numLaps);
        } else {
            setNotificationOld(clockBaseTime, clockRunning, numLaps);
        }
    }

    private void setNotificationOld(long clockBaseTime, boolean clockRunning, int numLaps) {
        ...
        Intent leftButtonIntent = null;
        Intent rightButtonIntent = null;
        if (clockRunning) {
            // Left button: lap
            leftButtonIntent = new Intent(context, StopwatchService.class);
            ...
            rightButtonIntent = new Intent(context, StopwatchService.class);
            ...
            if (numLaps > 0) {
                ...
                remoteViewsCollapsed.setViewVisibility(org.omnirom.deskclock.R.id.collapsed_text, View.GONE);
                remoteViewsExpanded.setViewVisibility(org.omnirom.deskclock.R.id.expanded_text, View.GONE);
            }
        } else {
    ...
    private void setNotificationNew(long clockBaseTime, boolean clockRunning, int numLaps) {
        Context context = getApplicationContext();
        // Intent to load the app for a non-button click.
        Intent intent = new Intent(context, DeskClock.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        if (clockRunning) {
            ...
            if (numLaps > 0) {
                ...
                remoteViewsCollapsed.setViewVisibility(org.omnirom.deskclock.R.id.notif_text, View.GONE);
                remoteViewsExpanded.setViewVisibility(org.omnirom.deskclock.R.id.notif_text, View.GONE);
            }
        } else {
            // Left button: reset clock
            Intent leftButtonIntent = new Intent(context, StopwatchService.class);
